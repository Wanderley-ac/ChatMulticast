...
public class Chat extends javax.swing.JFrame {
    ...
    //Inicializa o endereço multicast.
    ...
    public Chat(String username, String multicastAddress, int port) {
    ...
    private void initialConfiguration() {
        ...
        setTitle("[" + this.username + "] connect to [" + this.multicastAddress + ":" + this.port + "]");
    ...
    private void sendMessage() {
        ...
        try {
            ...
            DatagramPacket packet = new DatagramPacket(data, data.length, multicastGroup, this.port);
